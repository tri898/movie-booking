            ...
            <div class="row">
                ...
                <div class="card flex-fill">
                    <div class="card-header">
                        ...
                        @endif
                        <form action="{{ route('cms.user-manager.update', $admin->id) }}" method="POST"
                              id="userManagerForm">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-sm-3 mt-3">
                                    ...
                                    <x-dropzone-input formId="userManagerForm" paramName="avatar"
                                                      ...
                                                      acceptedFiles=".png, .jpg, .gif" :medias="$avatar"/>
                                </div>
                            ...
                            <input type="hidden" name="avatar" value="{{ old('avatar', $avatar?->getKey()) }}" />
                            <div class="mt-3">
